...
def shiftRow(state, sPtr, nbr):
	for i in range(nbr):
		state[sPtr:sPtr+4] = state[sPtr+1:sPtr+4] + state[sPtr:sPtr+1]
	return state
...
if __name__ == "__main__":
	key = 0x9310cd51c2a398b380845768793530f5
	plaintext = 0x0123456789abcdefabcdef0123456789
	...
	if ciphertext == 0xe9fb48cb64242bb2bf9c681cd023de0b:
		print ("-> CORRECT")
	else:
		print ("-> ERROR!!")
